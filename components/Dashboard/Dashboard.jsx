  ...
  return (
    <div className="bg-white text-white p-6 sm:p-8 md:p-14 lg:p-14 min-h-screen flex flex-col gap-4">
      <div className="flex md:flex-row flex-col justify-between gap-5 w-full">
        <div className="bg-[url('/images/wavs.jpg')] flex md:w-1/2 flex-col gap-6 bg-cover bg-no-repeat bg-center px-4 rounded-lg text-center w-full py-10">
          <h2 className="text-[19px] font-bold">Account Number</h2>
          <p className="text-[22px] font-extrabold">9349 9049 489</p>
        </div>
        <div className="bg-[url('/images/wavs.jpg')] flex flex-col md:w-1/2 gap-6 bg-cover bg-no-repeat bg-center px-4 rounded-lg text-center w-full py-10">
